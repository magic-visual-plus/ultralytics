...
# model.train(data=f'{train_base_dir}/dataset/data.yaml', device="cuda:0", resume='/root/.cache/trains/2b75f2b4-cf67-463b-9ff6-58c534dfb52e/output/output10/weights/best.pt', copy_paste=0.0, mixup=0.0, epochs=200, project=f"{train_base_dir}/output", name="output", model=pretrained_model_path, lr0=lr, workers=1, batch=8, imgsz=1280)
